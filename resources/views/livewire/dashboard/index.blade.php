                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow">
                        ...
                        <div class="p-5">
                            <div class="bg-white shadow rounded overflow-hidden group">
                                ...
                                <div class="pt-4 pb-3 px-4">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex gap-1 text-sm text-yellow-400">
                                            @for ($i = 0; $i < 5; $i++) @if ($i < $batik['rating']) <span><i class="fa-solid fa-star"></i></span>
                                                @else
                                ...
                                <button wire:click="productDetail({{ $batik['id'] }})"
                                    class="block w-full py-1 text-center text-white bg-[#6B4226] border border-[#6B4226] rounded-b hover:bg-transparent hover:text-[#6B4226] transition">Lihat
                                    Product</button>
                            </div>
                        </div>
                    </div>
