<!-- registration -->
<div class="contain pt-[50px]">
    {{-- Do your work, then step back. --}}
    <div class="max-w-lg mx-auto shadow px-6 py-10 rounded overflow-hidden border-white border-4 bg-[#fffaf0]">
        <div class="text-center">
            <h2 class="text-2xl uppercase font-medium mb-1">Pendaftaran Admin</h2>
            ...
            <div class="space-y-2">
                <div>
                    ...
                    <input type="text" wire:model.defer="nama" name="nama" id="nama"
                        class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-[#111827] placeholder-gray-400"
            ...
            <div class="mt-6">
                <div class="flex items-center">
                    <input type="checkbox" name="aggrement" id="aggrement"
                        class="text-[#111827] focus:ring-0 rounded-sm cursor-pointer">
                    <label for="aggrement" class="text-gray-600 ml-3 cursor-pointer">I have read and agree to the <a
                            href="#" class="text-[#111827]">terms & conditions</a></label>
                </div>
            </div>
            <div class="mt-4">
                <button type="submit"
                    class="block w-full py-2 bg-[#111827] border border-[#111827] rounded hover:bg-transparent hover:text-[#111827] transition uppercase font-roboto font-medium">Daftarkan</button>
            </div>
        </form>
    </div>
</div>
