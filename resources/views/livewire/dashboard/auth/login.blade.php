...
<div class="contain">
    ...
    <div class="max-w-lg mx-auto shadow rounded overflow-hidden border-white border-4 px-6 py-10 bg-[#fffaf0]">
        ...
        <form wire:submit.prevent="login" method="post">
            ...
            <div class="mt-4">
                <button type="submit"
                    class="block w-full py-2 text-center border border-[#6B4226] rounded bg-[#6B4226] hover:bg-transparent hover:text-[#6B4226] transition uppercase font-roboto font-medium">Login</button>
            </div>
        </form>
