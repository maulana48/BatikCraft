    ...
    <div class="container grid grid-cols-2 gap-6">
        <div>
            ...
            <div class="grid grid-cols-5 gap-4 mt-4">
                @if ($batikA->media)
                    <img src="{{ asset($batikA->media) }}" alt="product2" class="w-full cursor-pointer border border-[#6100c1]">
                @else
                    <img src="{{ asset('ecommerce-template-tailwind-1-main/public') }}../assets/images/products/product2.jpg" alt="product2" class="w-full cursor-pointer border border-[#6100c1]">
                @endif
                @foreach ($tipe_warnaA as $tw)
                    @if ($tw->media)
                        <img src="{{ asset($tw->media) }}" alt="product2" class="w-full cursor-pointer border">
                    @else
                        <img src="{{ asset('ecommerce-template-tailwind-1-main/public') }}../assets/images/products/product3.jpg" alt="product2" class="w-full cursor-pointer border">
                    @endif
                @endforeach
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex items-center mb-4">
                ...
                <div class="text-xs text-gray-500 ml-3">({{ $batik->review }} Reviews)</div>
            </div>
            <div class="space-y-2">
                <p class="text-gray-800 font-semibold space-x-2">
                    @if ({{ $batik->stok }})
                    <span>Availability: </span>
                    <span class="text-green-600">{{ $batik->stok }}</span>
            ...
            <div class="mt-6 flex gap-3 border-b border-gray-200 pb-5 pt-5">
                ...
                <a href="#"
                    class="border border-gray-300 text-gray-600 px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:text-[#6100c1] transition">
        ...
        <div class="grid grid-cols-4 gap-6">
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <div class="pt-4 pb-3 px-4">
                    <a href="#">
                        <h4 class="uppercase font-medium text-xl mb-2 text-gray-800 hover:text-[#6100c1] transition">Guyer
                            Chair</h4>
                    </a>
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <div class="pt-4 pb-3 px-4">
                    <a href="#">
                        <h4 class="uppercase font-medium text-xl mb-2 text-gray-800 hover:text-[#6100c1] transition">Bed
                            King Size</h4>
                    </a>
                    <div class="flex items-baseline mb-1 space-x-2">
                        <p class="text-xl text-[#6100c1] font-semibold">$45.00</p>
