        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <p class="space-x-2">
                    ...
                    <span class="text-gray-600">{{ $kategori['name'] }}</span>
                </p>
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex border border-gray-300 text-gray-600 divide-x divide-gray-300 w-max">
                    <button x-on:click="decrement()"
                        class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none">-</button>
        ...
        <div class="w-3/5 pt-6">
            ...
            <table class="table-auto border-collapse w-full text-left text-gray-600 text-sm mt-6">
                <tr>
                    ...
                    <th class="py-2 px-4 border border-gray-300 ">{{ $batik['color_type'] }}</th>
                </tr>
                <tr>
