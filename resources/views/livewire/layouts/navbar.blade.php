    ...
    <nav class="bg-gray-800">
        <div class="container flex">
            ...
            <div class="flex items-center justify-between flex-grow pl-12">
                ...
                <div class="flex items-center space-x-6 capitalize">
                    <button wire:click="login" href=""" class="text-gray-200 hover:text-white transition">Login</a>
                    <button wire:click="registration" href=""" class="text-gray-200 hover:text-white transition">Register</button>
                </div>
            </div>
        </div>
    </nav>
