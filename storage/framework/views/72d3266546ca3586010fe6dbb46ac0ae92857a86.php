<div class="bg-white shadow rounded overflow-hidden group">
    ...
    <div class="relative">
        <?php if($batik['media']): ?>
            <img src="<?php echo e(asset($batik['media'])); ?>" alt="product 1" class="w-full">
        <?php else: ?>
        ...
        <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            ...
            <button wire:click="productDetail(<?php echo e($batik['id']); ?>)"
    ...
    <div class="pt-4 pb-3 px-4">
        <a href="#">
            <h4 class="uppercase font-medium text-xl mb-2 text-gray-800 hover:text-[#6B4226] transition"><?php echo e($batik['nama']); ?>

            </h4>
        </a>
        <div class="flex items-baseline mb-1 space-x-2">
            <p class="text-xl text-[#6B4226] font-semibold">Rp. <?php echo e($batik['harga']); ?></p>
            
        </div>
        <div class="flex items-center">
            <div class="flex gap-1 text-sm text-yellow-400">
                <?php for($i = 0; $i < 5; $i++): ?>
                    <?php if($i < $batik['rating']): ?>
            ...
            <div class="text-xs text-gray-500 ml-3">(<?php echo e($batik['jumlah_review']); ?>)</div>
        </div>
    </div>
    <button wire:click="productDetail(<?php echo e($batik['id']); ?>)"
